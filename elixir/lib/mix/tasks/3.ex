defmodule Mix.Tasks.LeetcodeElixir.LongestSubstringNoRepeat do
  use Mix.Task
  ...
  @shortdoc "Longest substring without repeating characters"
  def run(_args) do
    IO.puts(Solution.length_of_longest_substring("abcabcbb"))
  end
end
